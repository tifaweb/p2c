...
//--------积分记录-----------
	...
	public function adminExport(){
		$operation = M('operation');
		$list=$operation->order('time DESC')->select();
		$data['title']="管理员操作记录";
		$data['name']=array(
							array('n'=>'ID','u'=>'id'),
							array('n'=>'操作者','u'=>'name'),
	...
	public function userExport(){
		$operation = D('User_log');
		$list=$operation->relation(true)->order('time DESC')->select();
		$data['title']="用户操作记录";
		$data['name']=array(
							array('n'=>'ID','u'=>'id'),
	...
	public function integralExport(){
		$operation = D('Money_log');
		$list=$operation->relation(true)->where('type>0')->order('time DESC')->select();
		$data['title']="积分记录";
		$data['name']=array(
							array('n'=>'ID','u'=>'id'),
							array('n'=>'操作者','u'=>'username'),
