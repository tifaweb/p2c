...
--
-- 表的结构 `ds_guaranteecomp`
--

CREATE TABLE IF NOT EXISTS `ds_guaranteecomp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'admin', '/index.php/Admin/Index/savesy', '参数修改成功', '127.0.0.1', 1450064894),
(2, 'admin', '/index.php/Admin/Index/delesy/id/13', '删除系统参数', '127.0.0.1', 1450064908);
...
CREATE TABLE IF NOT EXISTS `ds_shield_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(32, 1, 0, 30, '0', '安全保障', '', '', NULL, 'list', 'page', '', 1, 1, 3, 5, '1449818097');
...
(7, '地址', '请输入地址', '浙江省宁波市鄞州区南部商务区博纳大厦2004-2', 'sys_address', 1),
(8, '邮箱', '请输入邮箱', '819016953@qq.com', 'sys_email', 1),
(9, '联系人', '请输入联系人', '吴经理', 'sys_contact', 1),
(10, '邮编', '请输入邮编', '888888', 'sys_code', 1),
(11, '传真', '请输入传真', '0574-88888888', 'sys_fax', 1),
(12, '版权信息', '请输入版权信息', 'Copyright ©2013-2016 宁波天发网络所有 备案号浙ICP备111111号', 'sys_copy', 1),
...
(31, '公司所在地', '请输入办公地址', '浙江省宁波市鄞州区南部商务区博纳大厦2004-2', 'sys_officeAddress', 1),
...
INSERT INTO `ds_user` (`id`, `uid`, `username`, `email`, `password`, `pay_password`, `pid`, `time`) VALUES
(1, 0, 'abcd123456', 'abcd123456@123.dd', '91d10753d0bc50642ba2c7f2d3b381f2', 'f64af30f74b609299962ab02131f2428', 0, 1449814385);
