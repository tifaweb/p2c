...
(24, 24, '投资流程', '<img src=\"/Public/editor/attached/image/20140613/20140613011544_27707.png\" alt=\"\" />', 1, 31, 1, 1, 1, 0, '投资流程', '投资流程', '1402622152'),
...
(25, 25, '注册与登录', '<p>\r\n	<strong>如何成为爱投资的注册用户？</strong>\r\n</p>\r\n<p>\r\n	进入P2C官网首页（p2c.tifaweb.com），点击右上方的\"注册\"按钮，在页面的操作提示下\r\n，完成注册流程即可。\r\n</p>\r\n<p>\r\n	<strong>注册后投资时的交易密码是多少？</strong>\r\n</p>\r\n<p>\r\n	注册后，在没有修改交易密码的情况下，交易密码初始为注册时的登陆密码，可以通过个人中心的交易密码进行修改。\r\n</p>\r\n<p>\r\n	<strong>忘记登录用户名、登录密码怎么办？如何找回？</strong>\r\n</p>\r\n<p>\r\n	<p>\r\n		忘记登录密码，具体步骤如下：\r\n	</p>\r\n	<p>\r\n		1.点击首页\"登录\"按钮进入用户登录页面，点击\"忘记密码\"；\r\n	</p>\r\n	<p>\r\n		2.填写您当时注册的用户名，输入验证码，点击\"下一步\"；\r\n	</p>\r\n	<p>\r\n		3.您的注册邮箱中将会收到一封标题为\"重置登录密码\"的邮件，点击邮件中的\"点击重置密码\"按钮或是链接地址，将会进入\"重置登录密码\"页面；\r\n	</p>\r\n	<p>\r\n		4.重新输入设置您的登录密码。\r\n	</p>\r\n</p>\r\n<p>\r\n	<span id=\"__kindeditor_bookmark_start_24__\"></span>\r\n</p>', 1, 31, 1, 1, 1, 0, '注册与登录', '注册与登录', '1402361217'),
(26, 26, '安全', '<p>\r\n	<strong>如何增加密码的安全性？</strong>\r\n</p>\r\n<p>\r\n	<p>\r\n		<p>\r\n			请仔细阅读以下常见的安全措施：\r\n		</p>\r\n		<p>\r\n			1.密码要保密，且定期更改；\r\n		</p>\r\n		<p>\r\n			2.请使用较长、复杂的字母数字组合以提高密码强度，不要用生日等容易被别人猜中的密码；\r\n		</p>\r\n		<p>\r\n			3.如果使用了密码找回功能，请您及时删除我们发送给您的找回密码的邮件；\r\n		</p>\r\n		<p>\r\n			4.请记住不要与任何人共享您的密码。如果您已经与他人共享了密码，我们强烈建议您尽快更改；\r\n		</p>\r\n		<p>\r\n			5.您可能在不经意间使计算机受到病毒、木马、间谍软件、广告软件的感染，这些软件也可能记录并盗走您的密码！所以，请安装和使用杀毒软件。\r\n		</p>\r\n		<p>\r\n			<p class=\"ral-answer\">\r\n				<strong>什么是支付密码？忘记支付密码怎么办？</strong>\r\n			</p>\r\n			<p>\r\n				1.支付密码是您投资和提现时需要输入的密码，可在登录后进入\"我的账户-安全中心\"页面进行修改。\r\n			</p>\r\n			<p>\r\n				2.支付密码是不同于登录密码的资金安全保护机制，是特别用来保护您的资金安全的交易密码。即使您的账户密码处于异常状态，有支付密码保护就可以确保您的账户资金不被他人挪用。\r\n			</p>\r\n			<p>\r\n				3.如果您遗忘了支付密码，可以按照以下步骤重置支付密码：点击\"忘记密码\"后进入到\"我的账户-安全中心\"页面，点击\"修改支付密码\"。\r\n			</p>\r\n			<p>\r\n				<strong>如何修改邮件？</strong>\r\n			</p>\r\n			<p>\r\n				联系客服进行修改。\r\n			</p>\r\n		</p>\r\n	</p>\r\n	<p>\r\n		<br />\r\n	</p>\r\n</p>', 1, 31, 1, 1, 1, 0, '安全', '安全', '1402361480');
";   
...
(24, '1402360919', 0, 0, 0, 0, NULL),
(25, '1402361217', 0, 0, 0, 0, NULL),
(26, '1402361480', 0, 0, 0, 0, NULL);";	
...
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}automatic` (
  ...
  `approve` varchar(9) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `financial` varchar(13) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `way` tinyint(1) NOT NULL,
  `candra` tinyint(1) NOT NULL,
  `deadline` varchar(5) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `rates` tinyint(2) NOT NULL,
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}guarantee`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}guarantee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bid` int(11) NOT NULL,
  `idname` varchar(13) NOT NULL,
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}guaranteecomp`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}guaranteecomp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(3, 0, 'mem_assure', '20', '担保获取20积分'),
(4, 0, 'mem_flow', '20', '认购获取20积分'),
(5, 0, 'mem_other', '10', '其实操作添加积分'),
(6, 0, 'mem_certification', '10', '用户通过实名认证获得的积分 '),
(7, 0, 'mem_email_audit', '10', '用户通过邮箱认证获得的积分'),
(8, 0, 'mem_cellphone_audit', '10', '用户通过手机认证获得的积分'),
(9, 0, 'mem_video_audit', '10', '用户通过视频认证获得的积分'),
(10, 0, 'mem_site_audit', '10', '会员通过现场认证获得的积分');";	
...
(1, 3, '宁波鄞州支行', '王青山', '331232131231231231', 5);";		
...
(1, 1, 0, 1, '0', '关于我们', '', '', 'page', 'list', 'page', 'about', 22, 1, 3, 7, '1402485188'),
...
(21, 1, 0, 21, '0', '联系我们', '', '', 'page', 'list', 'page', 'contact', 22, 1, 3, 5, '1402485479'),
(28, 1, 0, 28, '0', '名词解释', '', '', NULL, 'list', 'content', 'explanation', 1, 1, 2, 5, '1385780428'),
(29, 1, 0, 29, '0', '收费规则', '收费规则', '收费规则', NULL, 'list', 'page', 'rules', 1, 1, 3, 5, '1402484614'),
...
(1, NULL, 'article', '1402485188', NULL, NULL, '<p>\r\n	此源码为免费开源版，只保留了必要的功能，适合学习和创业型公司代步程序。\r\n</p>\r\n<p>\r\n	此源码免费使用期至2015年6月20号，到期后如还需要使用此软件，请按授权协议中要求的保留必要的版权信息，或购买授权码；未实行的平台，本公司将会以邮件的形式告之，在收到邮件2周内未按本公司要求整改的，将通过法律途径以侵权理由提起诉送或以技术手段停止软件运行，因此造成的一切损失，本公司不给予任何赔付。\r\n</p>'),
...
(4, '网站LOGO', '请输入LOGO', '1402310802.1006.png', 'sys_logo', 3),
